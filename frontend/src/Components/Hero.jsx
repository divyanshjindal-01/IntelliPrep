    ...
    >
      ...
      <div className="w-full lg:w-1/2 mb-10 lg:mb-0">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          {/* Get Started triggers Navbar login modal */}
          <button
      ...
      <Link to="/about">
      <button className="bg-transparent border-2 border-[#D8B8FF] text-[#D8B8FF] hover:bg-[#D8B8FF]/10 px-8 py-3 rounded-full text-lg font-semibold cursor-pointer transition-shadow shadow hover:shadow-md">
            Learn More
          </button>
      </Link>
